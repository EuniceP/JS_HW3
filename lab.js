...
var numberValue     = 5;
var stringValue     = "eunice";
var nullValue       = null;
var undefinedValue  = undefined;
var undefinedValue2 = typeof(undefined); 
...
typeof nullValue;  //returns object
...
console.log("Because they are neat.");
console.log("Javascript and Ruby,");
console.log("They cannot be beat!");
...
while (guess != theTarget) {
	...
	console.log(typeof(guess),typeof(theTarget),guess,theTarget);
	if (guess > theTarget) {
		alert("Too high!");
	} else if (null) {
		alert("Too low!");
...
concatStrings("today","wasboring");  // output is: todaywasboring
...
function increment(numberPlusOne) {
	return numberPlusOne+1;
}

increment(500);  // output is: 501
...
repeatString(3, "Ha");  // output is: 'HaHaHa'
